...
This module provides pluggable tile extraction strategies similar to HistoLab,
organized in a GlassCut style minimal API.

Main Classes:
    - Tiler: Abstract base class for all tiling strategies
    - GridTiler: Regular grid tiling
    - RandomTiler: Random sampling based tiling
    - ConditionalTiler: Tissue-aware tiling
...
from .random import RandomTiler
from .conditional import ConditionalTiler
